...
class FlightSearchInput(BaseModel):
    ...
    start_date: datetime = Field(..., description="The start date for the flight search for the outbound_flight. E.g., '2025-06-01'")
    end_date: datetime = Field(..., description="The end date for the flight search for the return_flight. E.g., '2025-06-01'")
